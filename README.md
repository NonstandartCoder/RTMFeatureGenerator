...
|-------------|-------------|-------------|-------------|-------------|
| Заболевания молочной железы | 0.910 (при добавлении) | 0.909 | | Логистическая регрессия |
| Нарушения сознания (КЦГ) | 0.686  | Предыдущих результатов нет | | Метод опорных векторов |
